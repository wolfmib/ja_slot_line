...
try: 
    import package.fg_event_1_swap_et_sticky_wild as ja_event
except:
    import fg_event_1_swap_et_sticky_wild as ja_event
...
class agent():
    ...
    def __init__(self,default_excelname="job_card_03_mg_v2_case_1.xlsx",i_event_respin_setting=3,show_log=False,show_debug=False):
        ...
        # 🕵🏻‍♂️ 🕵🏻‍♂️ 🕵🏻‍♂️ : Respin Setting
        print("🕵🏻‍♂️: set respin , e.g. 3")
        self.event_respin_setting = int(input())



        # 🕵🏻‍♂️ 🕵🏻‍♂️ 🕵🏻‍♂️: wilds for future anlysis.
        self.wild_cnts_dict = {}
        ...
        self.S1_4_pay_score = float(input("S1: 3      score = 25\n"))
        self.S1_5_pay_score = float(input("S1: 3      score = 200\n"))
    ...
    def run(self,pytest_flag=False):
        ...
        for _ in range(self.event_respin_setting):
            ...
            # 🕵🏻‍♂️: swap et steicky wild: Default Change H1
            curr_list_r, self.mask_list , curr_wild_cnts = ja_event.swap_et_sticky(curr_list_r,self.mask_list,i_from="H1",i_to="W1")
            ...
            # 🕵🏻‍♂️  計算cur_wild_cnts 分佈,  H1->W1, with each spin's sticky_wilds.
            ...
            ## 💰 save one by one total respin 3次 可惡
    ...
    def end(self):
        ...
        # 🐼
        symbol_win_dict, self.main_pd  = ja_symbol_distribution.run_line(self.setting_linable_obj_list,[3,4,5],self.main_pd)
