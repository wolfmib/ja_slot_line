...
def analyzer_input_args():
    ...
    parser.add_argument('--setting_fg_times', type=int,default=9, help="[Jason]: Default 9 runs")
    ...
    parser.add_argument('--free_game_trigger_option', type=str, default="bigger", help="default is bigger  >= cnts,  you can set bigger_than  , >cnts")
    parser.add_argument('--free_game_trigger_cnts', type=int, default=3, help="default is >= 3,  you can set other value such as >= 4")
